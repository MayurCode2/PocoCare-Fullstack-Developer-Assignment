...
const Forecast = ({ date, icon, value, onClick, isSelected }) => {
  ...
  return (
    <div
      className={`forecast ${isSelected ? "selected" : ""}`}
    ...
    >
      ...
      <div className="row">
        <FontAwesomeIcon
          icon={icon} // Assuming 'icon' already contains the correct FontAwesome icon
